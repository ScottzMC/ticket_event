...
<head>
   ...
   <title><?php echo $sea->title; ?></title>
   <?php }else{ ?>
                            ...
                            <div class="gen-carousel-movies-style-2 movie-grid style-2">
                                <div class="gen-movie-contain">
                                    <div class="gen-movie-img">
                                        <img src="<?php echo base_url('uploads/events/'.$sea->image); ?>"
                                                    alt="<?php echo $sea->title; ?>">
                                    </div>
                                    <div class="gen-info-contain">
                                        <div class="gen-movie-info">
                                            <h3><a href="<?php echo site_url('event/detail/'.strtolower($sea->code)); ?>"><?php echo str_replace('-', ' ', $sea->title); ?></a></h3>
                                        </div>
                                        <div class="gen-movie-meta-holder">
                                            <ul>
                                                <li><?php echo $sea->category; ?></li>
                                                <li>
                                                    <a href="<?php echo site_url('event/detail/'.strtolower($sea->code)); ?>"><span>View</span></a>
                                                </li>
                                            </ul>
                                        </div>
                                    </div>
