...
<table border="0" align="center" cellpadding="0" cellspacing="0" role="presentation" width="100%" style="width:100%;max-width:100%;">
  ...
  <tr data-element="blue-logo" data-label="Logo">
    <td align="center" class="center-text">
      <img style="width:120px;border:0px;display: inline!important;" src="https://scottnnaghor.com/weegeedem/images/wee-logo.png" width="120" border="0" editable="true" data-icon data-image-edit data-url data-label="Logo" data-image-width alt="logo">
    </td>
  </tr>
  <tr>
    ...
    <td align="center" data-bgcolor="BgColor" bgcolor="#FFFFFF">
      ...
      <table border="0" align="center" cellpadding="0" cellspacing="0" role="presentation" width="100%" style="width:100%;max-width:100%;">
        <tr data-element="blue-headline" data-label="Headlines">
          <td class="center-text" data-text-style="Headlines" align="center" style="font-family:'Barlow',Arial,Helvetica,sans-serif;font-size:24px;line-height:54px;font-weight:900;font-style:normal;color:#222222;text-decoration:none;letter-spacing:0px;">
              <singleline>
                  <?php foreach($ticket as $tick){} ?>
                <div mc:edit data-text-edit>
                  <?php echo $tick->fullname; ?>
                </div>
                <div mc:edit data-text-edit>
                  Ticket - <?php echo str_replace('-', ' ', $tick->title); ?>
                </div>
                <div mc:edit data-text-edit>
                  Show - <?php echo str_replace('-', ' ', $tick->events); ?>
                </div>
                <div mc:edit data-text-edit>
                  Quantity - <?php echo $tick->quantity; ?>
                </div>
                <?php 
                if($type == 'gbp'){ ?>
                <div mc:edit data-text-edit>
                  Total Price - £<?php echo $tick->total; ?>
                </div>
                <?php }else if($type == 'usd'){ ?>
                <div mc:edit data-text-edit>
                  Total Price - $<?php echo $tick->total_usd; ?>
                </div>
                <?php }else if($type == 'shilling'){ ?>
                <div mc:edit data-text-edit>
                  Total Price - SHL<?php echo $tick->total_shilling; ?>
                </div>
                <?php }else if($type == 'leone'){ ?>
                <div mc:edit data-text-edit>
                  Total Price - LEO<?php echo $tick->total_leone; ?>
                </div>
                <?php } ?>
              </singleline>
          </td>
            ...
            <!--[if (gte mso 9)|(IE)]>
              <table border="0" cellpadding="0" cellspacing="0" align="center">
                <tr>
                  ...
                  <![endif]-->
                    <singleline>
                      <a href="https://scottnnaghor.com/weegeedem/home/view/<?php echo $type; ?>" mc:edit data-button data-text-style="Buttons" style="font-family:'Barlow',Arial,Helvetica,sans-serif;font-size:16px;line-height:20px;font-weight:700;font-style:normal;color:#FFFFFF;text-decoration:none;letter-spacing:0px;padding: 15px 35px 15px 35px;display: inline-block;"><span>Back to Home</span></a>
                    </singleline>
                  <!--[if (gte mso 9)|(IE)]>
                  </td>
                  <td align="center" width="35"></td>
            ...
            <!--[if (gte mso 9)|(IE)]>
              <table border="0" cellpadding="0" cellspacing="0" align="center">
                <tr>
                  ...
                  <![endif]
                    <singleline>
                      <a href="https://scottnnaghor.com/weegeedem/qrcode_api/generateqr.php?data=<?php echo $ticket_code; ?>" target="_blank" mc:edit data-button data-text-style="Buttons" style="font-family:'Barlow',Arial,Helvetica,sans-serif;font-size:16px;line-height:20px;font-weight:700;font-style:normal;color:#FFFFFF;text-decoration:none;letter-spacing:0px;padding: 15px 35px 15px 35px;display: inline-block;"><span>View Ticket</span></a>
                    </singleline>
                  <!--[if (gte mso 9)|(IE)]>
                  </td>
                  <td align="center" width="35"></td>
