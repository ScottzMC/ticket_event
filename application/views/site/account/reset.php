            ...
            <div class="row">
                <div class="col-lg-12">
                    <div class="text-center">
                        <form name="pms_login" id="pms_login" action="<?php echo base_url('reset'); ?>" method="POST">
                            <h4>Reset Your Account</h4>
                            <p class="login-username">
                                <label for="user_login">Code</label>
                                <input type="text" name="code" id="user_login" class="input">
                            </p>
                            <p class="login-username">
                            ...
                            <p class="login-submit">
                                <input type="submit" name="reset" id="wp-submit" class="button button-primary"
                                    value="Update">
                            </p>
                        </form>
                        <?php
