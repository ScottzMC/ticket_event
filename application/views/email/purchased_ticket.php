          ...
          <td class="center-text" data-text-style="Headlines" align="center" style="font-family:'Barlow',Arial,Helvetica,sans-serif;font-size:24px;line-height:54px;font-weight:900;font-style:normal;color:#222222;text-decoration:none;letter-spacing:0px;">
              <singleline>
                <div mc:edit data-text-edit>
                  Hi <?php echo $fullname; ?>, Please find below your ticket details below:
                </div>
                <div mc:edit data-text-edit>
                  Ticket - <?php echo str_replace('-', ' ', $title); ?>
                </div>
                <div mc:edit data-text-edit>
                  Show - <?php echo str_replace('-', ' ', $events); ?>
                </div>
                <div mc:edit data-text-edit>
                  ...
                  <table border="0" cellspacing="0" cellpadding="0" role="presentation" align="center" class="row" width="100%" style="width:100%;max-width:100%;">
                    ...
                    <tr>
                      <td class="center-text" data-text-style="Use Code" align="center" style="font-family:'Barlow',Arial,Helvetica,sans-serif;font-size:22px;line-height:26px;font-weight:700;font-style:normal;color:#0387EC;text-decoration:none;letter-spacing:4px;">
                          <singleline>
                            <div mc:edit data-text-edit>
                              Ticket code - <?php echo $ticket_code; ?>
                            </div>
                          </singleline>
                      </td>
                    </tr>
