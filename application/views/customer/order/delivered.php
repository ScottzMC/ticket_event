...
<head>
	...
	<title>View All Delivered Orders || Profile</title>
												...
												<thead>
												 ...
												 <tbody>
													...
													<tr>
                                                      ...
                                                      <td>
													     <button type="button" onclick="update_order(<?php echo $delved->id; ?>)" class="btn btn-info btn-icon-anim btn-square" title="Delete Order">
