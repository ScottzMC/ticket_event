...
<head>
	...
	<title>View All Cancelled Orders || Profile</title>
												...
												<thead>
												 ...
												 <tbody>
													...
													<tr>
                                                        ...
                                                        <td>
													     <button type="button" onclick="update_order(<?php echo $cancel->id; ?>)" class="btn btn-info btn-icon-anim btn-square" title="Delete Order">
