  ...
  <div class="wrapper">
    ...
    <div class="fixed-sidebar-left">
      <ul class="nav navbar-nav side-nav nicescroll-bar">
        ...
        <li>
          <a href="javascript:void(0);" data-toggle="collapse" data-target="#room_dr">
            <i class="icon-basket-loaded mr-10"></i>Room
            <span class="pull-right">
              <i class="fa fa-fw fa-angle-down"></i>
            </span>
          </a>
          <ul id="room_dr" class="collapse collapse-level-1">
            <li>
              <a href="<?php echo site_url('admin/view_room'); ?>">View Rooms</a>
            </li>
            <li>
              <a href="<?php echo site_url('admin/add_room'); ?>">Add Rooms</a>
            </li>
            <li>
              <a href="<?php echo site_url('admin/room_schedule'); ?>">Rooms Schedule</a>
            </li>
            <li>
              <a href="<?php echo site_url('admin/view_room_gallery'); ?>">Rooms Gallery</a>
            </li>
          </ul>
        </li>
        ...
        <li>
          <a href="javascript:void(0);" data-toggle="collapse" data-target="#book_dr">
            <i class="icon-grid mr-10"></i>Booking
            <span class="pull-right">
              <i class="fa fa-fw fa-angle-down"></i>
            </span>
          </a>
          <ul id="book_dr" class="collapse collapse-level-1">
            <li>
              <a href="<?php echo site_url('admin/booking_pending'); ?>">Pending</a>
            </li>
            <li>
              <a href="<?php echo site_url('admin/booked'); ?>">Booked</a>
            </li>
            <li>
              <a href="<?php echo site_url('admin/booking_cancelled'); ?>">Cancelled</a>
            </li>
          </ul>
        </li>
