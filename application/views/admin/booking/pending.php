...
<head>
	...
	<title>View All Pending Booking || Admin</title>
            ...
            <div class="container-fluid">
				...
				<div class="row heading-bg bg-pink">
					...
					<div class="col-lg-9 col-sm-8 col-md-8 col-xs-12">
					  <ol class="breadcrumb">
						<li><a href="<?php echo site_url('profile/dashboard'); ?>">Dashboard</a></li>
						<li><a href="#"><span>Booking</span></a></li>
						<li class="active"><span>Pending Booking</span></li>
					  </ol>
					</div>
					<!-- /Breadcrumb -->
				</div>
                ...
                <script>
                      ...
                      function delete_booking(id){
                        ...
                        $.post('<?php echo base_url('profile/delete_booking'); ?>', {"booking_id": booking_id}, function(data){
                          location.reload();
                          $('#ctd').html(data)
                          });
                        }
					...
					<div class="col-sm-12">
						<div class="panel panel-default card-view">
							<div class="panel-heading">
								<div class="pull-left">
									<h6 class="panel-title txt-dark">Pending Booking</h6>
								</div>
												...
												<thead>
												 ...
												 <tbody>
													...
													<tr>
                                                        ...
                                                        <td>
													     <button type="button" name="cancelled" onclick="cancel_booking(<?php echo $pend->id; ?>)" class="btn btn-danger btn-icon-anim btn-square" title="Cancelled Booking">
    ...
    $(document).ready(function(){
     ...
     $('#delete_all').click(function(){
      ...
      if(checkbox.length > 0){
       ...
       $.ajax({
        url:"<?php echo base_url(); ?>profile/delete_all_booking",
        method:"POST",
     ...
     $('#cancelled_all').click(function(){
      ...
      if(checkbox.length > 0){
       ...
       $.ajax({
        url:"<?php echo base_url(); ?>profile/cancelled_all_booking",
        method:"POST",
        data:{checkbox_value:checkbox_value},
        success:function(){
         $('.removeRow').fadeOut(1500);
