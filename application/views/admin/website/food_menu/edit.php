...
<div class="panel panel-default card-view">
  <div class="panel-heading">
    ...
    <div class="panel-body">
      <form action="<?php echo base_url('admin/food_menu/edit/'.$edt_menu->id); ?>" method="post" role="form">
      <p class="text-muted">Edit <code>Menu of the website.</code></p>
          ...
          <input type="text" name="rank" style="color: black;" value="<?php echo str_replace('-', ' ', $edt_menu->rank); ?>" /><br>
