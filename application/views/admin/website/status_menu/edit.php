...
<div class="panel panel-default card-view">
  <div class="panel-heading">
    ...
    <div class="panel-body">
      <form action="<?php echo base_url('admin/status_menu/edit/'.$edt_menu->id); ?>" method="post" role="form">
      <p class="text-muted">Edit <code> Status Menu of the website.</code></p>
          <br>
          <label class="control-label mb-10">Add Status Menu Category</label><br>
