...
<div class="panel panel-default card-view">
  ...
  <script>
    ...
    $.post('<?php echo base_url('admin/menu/delete_menu'); ?>', {"menu_id": menu_id}, function(data){
      location.reload();
      $('#cta').html(data)
      });
    }
...
<div class="panel panel-default card-view">
  <div class="panel-heading">
	...
	<div class="panel-wrapper collapse in">
    <div class="panel-body">
      <form action="<?php echo base_url('admin/menu/add'); ?>" method="post" role="form">
  ...
  <div class="panel-wrapper collapse in">
    <div class="panel-body">
      ...
      <div class="tags-default mt-40">
          ...
          <a href="<?php echo site_url('admin/menu/edit/'.$men->id); ?>" class="btn btn-danger btn-icon left-icon mr-10">
            <i class="fa fa-check"></i>
          </a>
          <br>
