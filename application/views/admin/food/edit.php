...
<html lang="en">
    ...
    <?php foreach($edit_food as $edt_fod){} ?>
		<title>Edit <?php echo str_replace('-', ' ', $edt_fod->title); ?> Admin </title>
		<!-- Favicon -->
  		...
  		<div class="page-wrapper">
              <div class="container-fluid">
                ...
                <li><a href="<?php echo site_url('admin/dashboard'); ?>">Dashboard</a></li>
  							<li><a href="<?php echo site_url('admin/food'); ?>"><span>All Foods</span></a></li>
							...
							<div class="panel panel-default card-view">
								<div class="panel-wrapper collapse in">
									<div class="panel-body">
										<div class="form-wrap">
											<form action="<?php echo base_url('admin/food/edit/'.$edt_fod->id); ?>" method="POST" role="form">
													...
													<div class="col-md-6">
														<div class="form-group">
                                                            ...
                                                            <select class="form-control" name="category" required>
                                                                <option value="<?php echo $edt_fod->menu_id; ?>"><?php echo $edt_fod->menu_category; ?></option>
																<?php
																$query = $this->db->query("SELECT * FROM menu ORDER BY category ASC")->result();
																if(!empty($query)){
																foreach($query as $qry){ ?>
																<option value="<?php echo $qry->id; ?>"><?php echo str_replace('-', ' ', $qry->category); ?></option>
									                            <?php } }else{ ?>
						...
						<div class="col-sm-12">
							<div class="panel panel-default card-view">
								<div class="panel-wrapper collapse in">
									<div class="panel-body">
										<div class="form-wrap">
											<form action="<?php echo base_url('admin/food/edit_image/'.$edt_fod->id); ?>" method="POST" enctype="multipart/form-data">
