...
<html lang="en">
	<head>
		...
		<title>Add New Food || Admin</title>
		<!-- Favicon -->
							...
							<div class="panel panel-default card-view">
								<div class="panel-wrapper collapse in">
									<div class="panel-body">
										<div class="form-wrap">
											<form action="<?php echo base_url('admin/food/add'); ?>" method="POST" enctype="multipart/form-data">
													...
													<div class="col-md-6">
														<div class="form-group">
                                                            ...
                                                            <select class="form-control" name="category" required>
                                                                <option>Select</option>
																<?php
																$query = $this->db->query("SELECT DISTINCT id, category FROM menu")->result();
																if(!empty($query)){
