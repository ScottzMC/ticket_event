							...
							<div class="panel panel-default card-view">
								<div class="panel-wrapper collapse in">
									<div class="panel-body">
										<div class="form-wrap">
											<form action="<?php echo base_url('admin/venue/edit/'.$edt->id); ?>" method="POST" enctype="multipart/form-data">
						...
						<div class="col-sm-12">
							<div class="panel panel-default card-view">
								<div class="panel-wrapper collapse in">
									<div class="panel-body">
										<div class="form-wrap">
											<form action="<?php echo base_url('admin/venue/edit_image1/'.$edt->id); ?>" method="POST" enctype="multipart/form-data">
