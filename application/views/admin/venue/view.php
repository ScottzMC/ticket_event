...
<head>
	...
	<title>View All Venues || Admin</title>
	<!-- Favicon -->
            ...
            <div class="container-fluid">
				...
				<!-- /Title -->
                 ...
                 <script>
                    ...
                    $.post('<?php echo base_url('admin/venue/delete_venue'); ?>', {"del_id": del_id}, function(data){
                      location.reload();
                      $('#cti').html(data)
                      });
                    }
											...
											<table class="table display product-overview mb-30" id="support_table">
												...
												<tbody>
													...
													<tr>
                                                        ...
                                                        <td>
                                                            <a href="<?php echo site_url('admin/venue/edit/'.$ven->id); ?>" class="btn btn-info btn-icon-anim btn-square" title="Edit Venue">
