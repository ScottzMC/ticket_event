                            ...
                            <div class="panel-wrapper collapse in">
								<div class="panel-body">
									<div class="table-wrap">
                                        ...
                                        ?>
													<tr>
													    <td><?php echo $rep->order_id; ?></td>
														<td><?php echo str_replace('-', ' ', $rep->title); ?></td>
														<td><?php echo str_replace('-', ' ', $men->category); ?></td>
														<td><?php echo str_replace('-', ' ', $rep->seating); ?></td>
														<td>&pound;<?php echo number_format($rep->price); ?></td>
                                                ...
                                                <div class="col-md-6">
													<div class="form-group">
                                                        <form action="<?php echo base_url('admin/report/food/filter/'.$rep->category); ?>" method="post">
