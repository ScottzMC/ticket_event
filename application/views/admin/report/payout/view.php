									...
									<div class="table-wrap">
										<div class="table-responsive">
											<table id="datable_1" class="table display product-overview mb-30">
												...
												<tbody>
                                                    <?php if(!empty($payout)){ foreach($payout as $pay){ 
                                        
                                        ?>
													<tr>
													    <td><?php echo $pay->id; ?></td>
														<td><?php echo str_replace('-', ' ', $pay->company); ?></td>
														<td><?php echo $pay->company_email; ?></td>
														<td>&pound;<?php echo number_format($pay->amount); ?></td>
														<td><?php echo $pay->status; ?></td>
														<td><?php echo $pay->notes; ?></td>
														<td><?php echo date('j M Y', strtotime($pay->start_date)); ?></td>
														<td><?php echo date('j M Y', strtotime($pay->end_date)); ?></td>
														<td><?php echo date('j M Y', strtotime($pay->created_date)); ?></td>
														<td><a href="<?php echo site_url('admin/report/payout/invoice/'.$pay->id); ?>" style="width: 150px;" class="btn btn-success btn-icon-anim btn-square" title="View">
                                                    View Invoice
                                                </a></td>
													</tr>
                                                <?php } }else{ echo ''; } ?>
                                                <div class="col-md-6">
													<div class="form-group">
                                                        <form action="<?php echo base_url('admin/report/payout/filter'); ?>" method="post">
											...
											<!--<div class="col-md-6">
												<div class="form-group">
												    <a href="<?php echo site_url('admin/report/payout/export'); ?>" target="_blank" style="width: 150px;" class="btn btn-success btn-icon-anim btn-square" title="Generate">
                                                        Generate Report
                                                    </a>
												</div>
										    </div>-->
