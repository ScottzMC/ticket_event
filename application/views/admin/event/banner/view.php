...
<head>
	...
	<title>View All Events Banner || Admin</title>
	<!-- Favicon -->
            ...
            <div class="container-fluid">
				...
				<!-- /Title -->
                 ...
                 <script>
                    ...
                    $.post('<?php echo base_url('admin/event/delete_event_banner'); ?>', {"del_id": del_id}, function(data){
                      location.reload();
                      $('#cti').html(data)
                      });
                    }
											...
											<table class="table display product-overview mb-30" id="support_table">
												...
												<tbody>
													...
													<tr>
                                                        ...
                                                        <td>
                                                            <a href="<?php echo site_url('admin/event/edit_banner/'.$ban->banner_id); ?>" class="btn btn-info btn-icon-anim btn-square" title="Edit Events">
