...
<head>
	...
	<title>View All Events Last Entry || Admin</title>
	<!-- Favicon -->
            ...
            <div class="container-fluid">
				...
				<!-- /Title -->
                 ...
                 <script>
                    ...
                    $.post('<?php echo base_url('admin/event/delete_event_last_entry'); ?>', {"del_id": del_id}, function(data){
                      location.reload();
                      $('#cti').html(data)
                      });
                    }
											...
											<table class="table display product-overview mb-30" id="support_table">
												...
												<tbody>
													...
													<tr>
                                                        ...
                                                        <td>
                                                            <a href="<?php echo site_url('admin/event/edit_last_entry/'.$last->last_id); ?>" class="btn btn-info btn-icon-anim btn-square" title="Edit Events">
