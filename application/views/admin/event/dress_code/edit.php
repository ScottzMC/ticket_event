								...
								<div class="panel-wrapper collapse in">
									<div class="panel-body">
										<div class="form-wrap">
											...
											<form action="<?php echo base_url('admin/event/edit_dress_code/'.$edt->id); ?>" method="POST" enctype="multipart/form-data">
											...
											<!--<form action="<?php echo base_url('admin/event/edit_dress_code_image/'.$edt->id); ?>" method="POST" enctype="multipart/form-data">
												<div class="row">
													<div class="col-lg-12">
														<label>Image</label>
