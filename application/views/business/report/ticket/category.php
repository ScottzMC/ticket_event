...
<head>
	...
	<title>View <?php echo $tick->title; ?> Report || Business</title>
	<!-- Favicon -->
				...
				<div class="row heading-bg bg-pink">
					...
					<div class="col-lg-9 col-sm-8 col-md-8 col-xs-12">
					  <ol class="breadcrumb">
						...
						<li><a href="<?php echo site_url('business/report/ticket'); ?>"><span>Ticket Report</span></a></li>
									...
									<div class="table-wrap">
										<div class="table-responsive">
											<table id="datable_1" class="table display product-overview mb-30">
												...
												<tbody>
                                                    <?php if(!empty($report)){ foreach($report as $rep){ 
                                        ?>
													<tr>
													    <td><?php echo $rep->ticket_code; ?></td>
														<td><?php echo str_replace('-', ' ', $rep->title); ?></td>
														<td><?php echo $rep->fullname; ?></td>
														<?php if($gbp > 0){ ?>
														...
														<td>LE<?php echo 0; ?></td>
														<?php } ?>-->
														<td><?php echo date('j M Y', strtotime($rep->created_date)); ?></td>
													</tr>
                                                <?php } }else{ echo ''; } ?>
                                                <div class="col-md-6">
													<div class="form-group">
                                                        <form action="<?php echo base_url('business/report/ticket/filter/'.$id); ?>" method="post">
											...
											<div class="col-md-6">
												<div class="form-group">
												    <a href="<?php echo site_url('business/report/ticket/export/'.$id); ?>" target="_blank" style="width: 150px;" class="btn btn-success btn-icon-anim btn-square" title="Generate">
                                                        Generate Report
                                                    </a>
												</div>
										    </div>
