									...
									<div class="table-wrap">
                                        ...
                                        ?>
													<tr>
														...
														<td><a href="<?php echo site_url('business/report/payout/invoice/'.$pay->id); ?>" style="width: 150px;" class="btn btn-success btn-icon-anim btn-square" title="View">
                                                    View Invoice
                                                </a></td>
													</tr>
                                                <?php } }else{ echo ''; } ?>
											...
											<div class="col-md-6">
												<div class="form-group">
												    <a href="<?php echo site_url('business/report/payout/add'); ?>" target="_blank" style="width: 150px;" class="btn btn-success btn-icon-anim btn-square" title="Make Payout">
                                                        Payout Request
                                                    </a>
												</div>
										    </div>
