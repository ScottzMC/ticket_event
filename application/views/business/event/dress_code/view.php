...
<head>
	...
	<title>View All Events Dress code || Business</title>
	<!-- Favicon -->
            ...
            <div class="container-fluid">
				...
				<!-- /Title -->
                 ...
                 <script>
                    ...
                    $.post('<?php echo base_url('business/event/delete_event_dress_code'); ?>', {"del_id": del_id}, function(data){
                      location.reload();
                      $('#cti').html(data)
                      });
                    }
											...
											<table class="table display product-overview mb-30" id="support_table">
												...
												<tbody>
													...
													<tr>
                                                        ...
                                                        <td>
                                                            <a href="<?php echo site_url('business/event/edit_dress_code/'.$dress->dress_id); ?>" class="btn btn-info btn-icon-anim btn-square" title="Edit Events">
