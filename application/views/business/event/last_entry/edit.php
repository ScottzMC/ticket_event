              ...
              <div class="container-fluid">
  				...
  				<div class="row heading-bg  bg-pink">
  					<div class="col-lg-3 col-md-4 col-sm-4 col-xs-12">
  					  <h5 class="txt-light">Upload Events Last Entry</h5>
  					</div>
  					<!-- Breadcrumb -->
  					<div class="col-lg-9 col-sm-8 col-md-8 col-xs-12">
  					  <ol class="breadcrumb">
                            <li><a href="<?php echo site_url('business/dashboard'); ?>">Dashboard</a></li>
  							...
  							<li class="active"><span>Edit Events Last Entry</span></li>
  					  </ol>
  					</div>
  					<!-- /Breadcrumb -->
  				</div>
								...
								<div class="panel-wrapper collapse in">
									<div class="panel-body">
										<div class="form-wrap">
											...
											<form action="<?php echo base_url('business/event/edit_last_entry/'.$edt->id); ?>" method="POST" enctype="multipart/form-data">
											...
											<!--<form action="<?php echo base_url('business/event/edit_last_entry_image/'.$edt->id); ?>" method="POST" enctype="multipart/form-data">
												<div class="row">
													<div class="col-lg-12">
														<label>Image</label>
