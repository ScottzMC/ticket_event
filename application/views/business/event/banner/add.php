...
<html lang="en">
	<head>
		...
		<title>Add New Events Banner|| Business</title>
		<!-- Favicon -->
  					...
  					<div class="col-lg-9 col-sm-8 col-md-8 col-xs-12">
  					  <ol class="breadcrumb">
                            <li><a href="<?php echo site_url('business/dashboard'); ?>">Dashboard</a></li>
  							...
  							<li class="active"><span>Upload a Events Banner</span></li>
  					  </ol>
  					</div>
  					<!-- /Breadcrumb -->
  				</div>
							...
							<div class="panel panel-default card-view">
								<div class="panel-wrapper collapse in">
									<div class="panel-body">
										<div class="form-wrap">
											<form action="<?php echo base_url('business/event/add_banner'); ?>" method="POST" enctype="multipart/form-data">
