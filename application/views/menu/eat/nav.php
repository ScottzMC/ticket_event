                        ...
                        <div class="border-bottom-6">
                            <div class="row align-items-center">
                                <div class="col-xl-3 col-lg-2">
                                    <div class="logo">
                                        <a href="<?php echo site_url('eat'); ?>"><img height="180" src="<?php echo base_url('images/wee-logo.png'); ?>" alt="logo"></a>
                                    </div>
                                </div>
                                    ...
                                    <div class="main-menu main-menu-padding-1 main-menu-lh-3 main-menu-hm4 main-menu-center">
                                        <nav>
                                            <ul>
                                                ...
                                                <li><a style="font-size: 12px;" href="<?php echo site_url('customer/dashboard'); ?>">Profile </a></li>
                                                    <li><a style="font-size: 12px;" href="<?php echo site_url('logout'); ?>">Logout </a></li>
                                                ...
                                                <li><a style="font-size: 12px;" href="<?php echo site_url('kitchen/dashboard'); ?>">Kitchen </a></li>
                                                    <li><a style="font-size: 12px;" href="<?php echo site_url('logout'); ?>">Logout </a></li>
                                                <?php }else{ ?>
                                                    <li><a style="font-size: 12px;" href="<?php echo site_url('login'); ?>">Login </a></li>
                                                    <li><a style="font-size: 12px;" href="<?php echo site_url('register'); ?>">Register </a></li>
                                                <?php } ?>
                                            </ul>
                                        </nav>
                                    </div>
                    ...
                    <div class="row align-items-center">
                        <div class="col-5">
                            <div class="mobile-logo">
                                <a href="<?php echo site_url('eat'); ?>">
                                    <img alt="logo" src="<?php echo base_url('assets/images/wee-logo.png'); ?>">
                                </a>
                            </div>
                        </div>
                        <div class="col-7">
                ...
                <div class="mobile-header-content-area">
                    <div class="mobile-menu-wrap mobile-header-padding-border-2">
                        ...
                        <nav>
                            ...
                            <?php if($this->session->userdata('urole') == 'User'){ ?>
                             <li><a target="_blank" href="< ?php echo site_url('customer/dashboard'); ?>">Profile</a></li>
                                <li><a style="font-size: 12px;" href="<?php echo site_url('logout'); ?>">Logout </a></li>
                            <?php }else if($this->session->userdata('urole') == 'Admin'){ ?>
                                <li><a target="_blank" href="< ?php echo site_url('admin/dashboard'); ?>">Admin</a></li>
                                <li><a style="font-size: 12px;" href="<?php echo site_url('logout'); ?>">Logout </a></li>
                            <?php }else if($this->session->userdata('urole') == 'Kitchen'){ ?>
                                <li><a target="_blank" href="< ?php echo site_url('kitchen/dashboard'); ?>">Kitchen</a></li>
                                <li><a style="font-size: 12px;" href="<?php echo site_url('logout'); ?>">Logout </a></li>
                            <?php }else{ ?>
                                <li><a style="font-size: 12px;" href="<?php echo site_url('login'); ?>">Login </a></li>
                                <li><a style="font-size: 12px;" href="<?php echo site_url('register'); ?>">Register </a></li>
            ...
            <div class="sidebar-cart-all">
                ...
                <div class="cart-content">
                      ...
                      ?>
                        <li class="single-product-cart">
                            ...
                            <div class="cart-delete">
                                <a href="<?php echo site_url('eat/remove_cart/'.$item['rowid']); ?>">×</a>
                            </div>
                        </li>
                        <?php endforeach; ?>
                        <?php endif; ?>
                    ...
                    <div class="cart-checkout-btn">
                        <a class="btn-hover cart-btn-style" href="<?php echo site_url('eat/view_cart'); ?>">view cart</a>
                        <br>
                        <a class="btn-hover cart-btn-style" href="<?php echo site_url('eat/checkout'); ?>">Proceed to checkout</a>
                    </div>
                </div>
            </div>
        </div>