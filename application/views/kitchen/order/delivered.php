...
<head>
	...
	<title>View All Delivered Orders</title>
	<!-- Favicon -->
												...
												<thead>
												 ...
												 <tbody>
													...
													<tr>
                                                        ...
                                                        <td>
													     <button type="button" name="delivering" onclick="deliveringorder(<?php echo $delved->id; ?>)" class="btn btn-info btn-icon-anim btn-square" title="Delivering Order">
                                                           <i class="icon-check"></i>
                                                         </button>
                                                        </td>
                                                        <td>
													     <button type="button" name="delivered" onclick="deliveredorder(<?php echo $delved->id; ?>)" class="btn btn-success btn-icon-anim btn-square" title="Delivered Order">
                                                           <i class="icon-check"></i>
                                                         </button>
                                                        </td>
                                                        <td>
                                                        ...
                                                        <td>
                            							  <button type="button" class="btn btn-danger btn-icon-anim btn-square" onclick="deleteorder(<?php echo $delved->id; ?>)" title="Delete Order">
                                                           <i class="icon-trash"></i>
                                                         </button>
                                                        </td>
													</tr>
    ...
    $(document).ready(function(){
     ...
     $('#deliver_all').click(function(){
      ...
      if(checkbox.length > 0){
       ...
       $.ajax({
        url:"<?php echo base_url(); ?>admin/orders/deliver_all",
        method:"POST",
        data:{checkbox_value:checkbox_value},
        success:function(){
         $('.removeRow').fadeOut(1500);
