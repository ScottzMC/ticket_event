            ...
            <div class="container">
                <div class="breadcrumb-content text-center">
                    <ul>
                        ...
                        <li>
                            <a href="<?php echo site_url('eat/view_cart'); ?>">Shopping Cart</a>
                        </li>
                    ...
                    <div class="col-lg-12 col-md-12 col-sm-12 col-12">
                        <div class="panel panel-default credit-card-box">
                            ...
                            <div class="panel-body">
                                ...
                                <form role="form" action="<?php echo base_url('eat/stripe_order_post'); ?>" method="post" 
